...
done < <( { find GamesRoom/Views GamesRoom/Services GamesRoom/Support GamesRoomWidgets GamesRoomWatch -type f -name '*.swift' | sort; find GamesRoom -maxdepth 1 -type f -name '*.swift' | sort; } )
